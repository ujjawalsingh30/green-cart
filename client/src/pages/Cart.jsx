...
const Cart = () => {
    ...
    const [selectedAddresses, setSelectedAddress] = useState(dummyAddress[0])
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={()=> {navigate("/products"); scrollTo(0,0)}} className="group cursor-pointer flex
                 items-center mt-8 gap-2 text-primary font-medium">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddresses ?`$
                        {selectedAddresses.street}, ${selectedAddresses.city}, $
                        {selectedAddresses.state}, ${selectedAddresses.country}` : "No address found"}</p>
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-primary-dull transition">
                   {PaymentOption === "COD" ? "place Order" : "Procceed to Checkout"}
                </button>
            </div>
        </div>
    ): null
