...
//                     <img src={assets.nav_cart_icon} alt='carr' className='w-6 opacity-80' />
...
//                         <button onClick={logout} className="cursor-pointer px-6 py-2 mt-2 bg-primary
//                  hover:bg-primary-dull transition text-white rounded-full text-sm">
//                             Logout
//                         </button>
//                     )}
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick={() => navigate('/cart')} className="relative cursor-pointer">
                    <img src={assets.nav_cart_icon} alt="cart" className='h-6 opacity-80' />
