...
md:justify-center pb-24 md:pb-0 pxx-4 md:pl-18 lg:pl-24'>
    ...
    max:-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15'
            ...
            <div className='flex items-center mt-6 font-medium'>
                <Link to={'/products'} className='group flex item-center gap-2 px-7 md:px-9 py-3 bg-primary
    hover:bg-primary-dull transition rounded text-white cursor-pointer'>
                    Shop now
                    <img className='md:hidden transition group-focus-focus:translate-x-1' src={assets.white_arrow_icon} alt="arrow" />
                </Link>
